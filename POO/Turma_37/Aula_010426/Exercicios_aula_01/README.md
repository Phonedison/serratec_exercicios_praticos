1 Calculadora de Média: Declare duas variáveis do tipo double para notas de um aluno. Calcule
a média e exiba: "Aprovado" se for >= 7, "Reprovado" se < 7, e "Aprovado Parabéns" se for
exatamente 10.
...
4 Tabuada com For: Utilize a estrutura for para imprimir a tabuada do número 5 (de 5x1 até
5x10).
...
6 Desconto INSS: Crie uma variável para o salário. Aplique a lógica de regra do INSS e exiba o
