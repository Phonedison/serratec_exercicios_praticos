...
--> TABELA PACIENTE
  ...
  VALUES
    ('Ana Maria Silva',           '12345678900',   '1993-05-20',   '11999887766',   'ana.silva@mail.com',       'Rua das Flores, 100',   NULL),
    ('Marcos Paulo Lima',         '23456789011',   '1980-08-12',   '11988776655',   'marcos.lima@mail.com',     'Av. Brasil, 210',       NULL),
    ('Pedro Almeida Oliveira',    '34567890122',   '1989-10-15',   '11977665544',   'pedro.almeida@mail.com',   'Rua Joana, 31',         NULL),
    ('Paula Tejando Souza',       '45678901233',   '2001-09-07',   '11999886677',   'paula.souza@mail.com',     'Rua Curitiba, 44',      NULL),
    ('Roberto Monteiro Dias',     '56789012344',   '1996-04-04',   '11999885522',   'roberto.dias@mail.com',    'Av. Paulista, 90',      NULL),
    ('Luciana Gomes Torres',      '67890123455',   '1987-09-21',   '11999884321',   'luciana.torres@mail.com',  'Rua Verde, 17',         NULL),
    ('Camila Santoro Castro',     '78901234566',   '1995-12-23',   '11999881100',   'camila.castro@mail.com',   'Rua Bela, 75',          NULL),
    ('Mateus Tamaki Ramos',       '89012345677',   '1973-11-19',   '11999880099',   'mateus.ramos@mail.com',    'Av. Central, 333',      NULL),
    ('Bianca Prado Oliveiro',     '90123456788',   '1988-04-28',   '11998887766',   'bianca.prado@mail.com',    'Rua Prisma, 111',       NULL),
    ('Sergio Nunes Albuquerque',  '01234567899',   '1999-07-22',   '11994442233',   'sergio.nunes@mail.com',    'Av. Santos, 2',         NULL);
...
VALUES
    ('2024-05-10 08:30',      'Limpeza de rotina e aplicação de flúor	Enxaguante bucal sem álcool',          'Realizado',      1,	1),
    ('2024-05-10 10:00',      'Avaliação de dor no siso superior	Agendamento de extração',                  'Agendada',       2,	7),
    ('2024-05-11 14:00',      'Restauração em resina composta (dente 26)	Evitar alimentos duros por 24h',   'Realizado',      3,	2),
    ('2024-05-12 09:15',      'Ajuste de aparelho ortodôntico	Troca das ligaduras elásticas',                'Realizado',      4,	1),
    ...
    ('2024-05-14 16:45',      'Clareamento dental de consultório	Gel dessensibilizante',                    'Realizado',      8,	6),
